...
namespace SP
{
    ...
    public partial class SegundoParcial: Form
    {
        ...
        {
            MessageBox.Show("Suarez Murray, Demian Jose 2A");
        }
        ...
        {
            SqlConnection conexion = new SqlConnection("Server=LAB4PC11\\SQLEXPRESS;Database=sp_lab_II;" +
                "Trusted_Connection=True;");
            SqlCommand traer = new SqlCommand("SELECT * FROM frutas", conexion);
